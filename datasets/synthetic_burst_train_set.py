...
class SyntheticBurst(torch.utils.data.Dataset):
    ...
    def __init__(self, base_dataset, burst_size=8, crop_sz=384, transform=tfm.ToTensor()):
        ...
        # iso kernel
        degradation_params = {'random_kernel': True,
                              'ksize': 31,
                              'sig_min': 0.2,
                              'sig_max': 5.0,
                              'rate_iso': 1.0,
        ...
        self.prepro = util.SRMDPreprocessing(
            scale=self.downsample_factor, cuda=False, **degradation_params
          )
    ...
    def __getitem__(self, index):
        ...
        # Generate RAW burst
        burst, frame_gt, kernels, _, flow_vectors, meta_info = rgb2rawburst(frame_crop,
                                                                           self.burst_size,
                                                                           prepro=self.prepro,
        ...
        return burst, frame_gt, kernels, flow_vectors, meta_info
