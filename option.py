...
parser.add_argument('--kernel_size', type=int, default=31,
                    help='aniso kernel size')
parser.add_argument('--burst_channel', type=int, default=1,
                    help='burst size, max 14')
...
parser.add_argument('--ker_code_length', type=int, default=15,
                    help='kernel pca length')
...
parser.add_argument('--load_sr', action='store_true',
                    help='load sr module from other model')
parser.add_argument('--finetune_head', action='store_true',
                    help='load head from other model')
parser.add_argument('--finetune_large', action='store_true',
                    help='load head from other model')
parser.add_argument('--finetune_large_skip', action='store_true',
                    help='load head from other model')
parser.add_argument('--finetune_pcd', action='store_true',
                    help='load head from other model')
